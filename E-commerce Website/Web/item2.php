...
<body>
    ...
    <div class="i1Desc">
    <img src="pants2.png" height="500px" width="400px" class="informationPicture">
...
<div class="bigBoxItem">
    <p class="bigInfo">3LAWI Pants, made in Bangladesh.<br> Price: 25JD<br> Available sizes: <b>XS, S, M, L, XL</b>  (Sizes for kids coming soon)<br>
