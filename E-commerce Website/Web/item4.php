...
<body>
    ...
    <div class="i1Desc">
    <img src="shirt.png" height="500px" width="400px" class="informationPicture">
...
<div class="bigBoxItem">
    <p class="bigInfo">3LAWI shirt, made in Bangladesh.<br> Price: 35JD<br> Available sizes: <b>XS, S, M, L, XL</b>  (Sizes for kids coming soon)<br>
